...
import bug from "../assets folder/games types/bug.png";
import dark from "../assets folder/games types/dark.svg";
import dragon from "../assets folder/games types/dragon.png";
import electric from "../assets folder/games types/electric.svg";
import fairy from "../assets folder/games types/fairy.svg";
import fighting from "../assets folder/games types/fighting.svg";
import fire from "../assets/games types/fire.png";
import flying from "../assets folder/games types/flying.png";
import ghost from "../assets folder/games types/ghost.png";
import grass from "../assets folder/games types/grass.png";
import ground from "../assets folder/games types/ground.svg";
import ice from "../assets folder/games types/ice.svg";
import normal from "../assets folder/games types/normal.svg";
import poison from "../assets folder/games types/poison.svg";
import psychic from "../assets folder/games types/psychic.svg";
import rock from "../assets folder/games types/rock.svg";
import steel from "../assets folder/games types/steel.svg";
import water from "../assets folder/games types/water.svg";
